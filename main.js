...
function createCard(data){
    ...
    max.innerHTML = "Максимальная t: " + data.main.temp_max + "°C" 
    card.appendChild(max)

    let min = document.createElement('div')
    min.innerHTML = "Минимальная t: " + data.main.temp_min + "°C"
    ...
    pressureImg.setAttribute('src', 'img/pressure.svg')
    ...
    humidityImg.setAttribute('src', 'img/humidity.svg')
    ...
    windImg.setAttribute('src', 'img/wind.svg')
